<?php
/**
 * Template Name: community create an alert
        ...
        <div class="col-lg-10 col-md-12 col-sm-12 mx-auto">
            <form method="POST" autocomplete="off">
                <div class="form-group">
                    <input type="text" name="comm_alert_detsls" class="form-control cf_crt_searchbar" required>
                ...
                <div class="cf_crtalert_btn">
                        <input type="submit" name="submit_comm_alert" value="Create Alert">
                </div>
                <div class="cf_seloption">
                    <p>My Alerts</p>
                    <ul>
                    <?php
                         ...
                         if($comm_user_meta){
                             $basurl = home_url().'/community-alerts-page';
                            foreach( $comm_user_meta as $comm_user_meta_value){
                                ?><li><a href="<?php echo $basurl.'?alert='.$comm_user_meta_value?>"><?php echo $comm_user_meta_value;?></a></li><?php
                            }
                         }
                     ?>
                    </ul>
