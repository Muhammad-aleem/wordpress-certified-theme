<?php
/**
 * Template Name: Entertainment Show Rentals
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <div class="offset-lg-3 col-lg-9 col-md-12 col-sm-12">
                        <ul class="nav nav-tabs cf_ent_tabs cf_movie_put_tab" id="myTab" role="tablist">
                            <li class="nav-item pl-0">
                                <a class="nav-link " id="movie_purchases_id_tab" data-toggle="tab" href="#movie_purchases_id" role="tab" aria-controls="movie_purchases_id_tab" aria-selected="true">Movie Purchases (9)<a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" id="show_rentals_id_tab" data-toggle="tab" href="#show_rentals_id" role="tab" aria-controls="show_rentals_id_tab" aria-selected="false">Show Rentals (6)</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade " id="movie_purchases_id" role="tabpanel" aria-labelledby="movie_purchases_id_tab">
                            <div class="row mb-20">
                    ...
                    <div class="tab-pane fade show active" id="show_rentals_id" role="tabpanel" aria-labelledby="show_rentals_id_tab">
