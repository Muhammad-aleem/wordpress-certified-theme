<?php
/**
 * Template Name: Author Public Traveland
            ...
            <div class="offset-lg-6 offset-md-6 col-lg-6 col-md-6 col-md-6 col-sm-12">
                <div class="al_hmainicon text-right">
                    <ul>
                        ...
                        <li>
                            <a href="#">
                                <img src="<?php echo $get_path?>/public/image/youtube.png"
                                    class="img-fluid al_Hcfyoutube">
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <img src="<?php echo $get_path?>/public/image/twitter.png"
             ...
             if($authorid ==  $trald_get_user_id){
                ...
                <div class="col-lg-2 col-md-2 col-sm-12">
                    ...
                    <?php
                        ...
                        $remKey = array_search( $trald_get_user_id, $user_followers);
                            ...
                            <ul>
                                ...
                                <li class="al_revthumbicn">
                                    <a href="#" class="wp_trald_thumb">
                                        <img src="<?php echo get_template_directory_uri(); ?>/public/image/thumbicn.png"
                                            class="img-fluid">
