<?php
/**
 * Template Name: Traveland Alerts page
...
$basurl = home_url().'/traveland-create-an-alert';
            ...
            <div class="cf_trv_post_sec">
                <a href="<?= $traveland_alert_page;?>">
                    <span>
                        ...
                        <span class="cf_trv_post_secredic mr-0 pl-0"> post</span>
                    </span>
                </a>
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-md-3 col-sm-12">
            <div class="cf_crt_alert">
                <a href="<?= $basurl;?>" class="text-decoration-none">Create an Alert</a>
            </div>
        </div>
            ...
            if ( $loop->have_posts() ) :
                ...
                <?php endif;
                    ...
                    if(!empty($traveld_user_meta)){
                        foreach($traveld_user_meta as $val){
                            $args = array(  
                                'post_type' => 'traveland',
                                's' => $val,
                                'post_status' => 'publish',
