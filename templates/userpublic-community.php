<?php
/**
 * Template Name: User Public community
                  ...
                  <div class="al_revicnlils comm_shareicn cf_comm_usermb">
                    <ul>
                        ...
                        <li class="al_revthumbicn">
                            ...
                            ?>
                            <?= $like_img;?>
                                <input type="hidden" class="comm_like_postval" value="<?php echo $get_the_post_id;?>">
                                <input type="hidden" class="comm_like_currentuser" value="<?php echo  $comm_get_user_id;?>">
                            </a>
                        </li>
