<?php
/**
 * Template Name: Business Uplode Image
...
if(isset($_POST['bus_image_uplode'])){


    $business_post_id = get_user_meta(get_current_user_id(), 'wp_business_post_id', true );

    if ( ! empty( $_FILES['bus_image_galleryname'] )  ) {
        $save_value = '';
        $files = $_FILES['bus_image_galleryname'];
        foreach ($files['name'] as $key => $value){
            ...
            $_FILES = array("bus_image_galleryname" => $file);
            $i=1;
                foreach ($_FILES as $file => $array) {
                      if ($_FILES[$file]['error'] !== UPLOAD_ERR_OK) __return_false();
                        ...
                        $attachment_id = media_handle_upload($file, $business_post_id);
                        $save_value .= $attachment_id . ",";
                        $i++;
                }
                update_post_meta($business_post_id, '_business_image_gallery_val',  $save_value);
        }
    }
            ...
            <div class="row">
                <div class="col-lg-3 col-md-3">
                        ...
                        <div class="cf_bus_sidebar_link">
                            ...
                            <a href="<?= $business_uplode_image;?>" class="text-decoration-none active" >Images</a>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="cf_business_content">
                        ...
                        <div class="cf_business_content_tit">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6">
                                    <div class="cf_business_content_des">
                                        <p>Upload Business Images <br>
                                            Certified BOC sorts photos automaticly.
                                        </p>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    <div class="cf_business_content_des cf_business_content_rightdes">
                                        <p>
                                            Recommended Profile Image <br>
                                            Size over 500 pixels <br>
                                            Max File Sizes 6 MB 
                                        </p>
                                    </div>
                                </div>
                        ...
                        <div class="business_content_img">
                            <div class="business_content_inputimg">
                                    <div class="bus_image_galleryinput">
                                        <input type="text" >
                                        <span>image File Name</span>
                                        <span>File Size</span>
                                    </div>
                                <label class="bus_image_gallery">
                                    <img src="<?php echo $dir_path?>/public/image/uplode_img.png" alt="" class="img-fluid cf_review_head_img">
                                    <input type="file" size="60" name="bus_image_galleryname[]" multiple="multiple">
                                    <span>Upload Image</span>
                                </label>
                            </div>
                        </div>
                        <div class="business_content_foter">
                            <p>View images on your Partner Page (Images loaded can not be deleted)</p>
                        </div>
                        <div class="business_uplodeimg">
                            <button type="submit" name="bus_image_uplode">Uplode</button>
                        </div>
                        </form>
                    </div>
                </div>
