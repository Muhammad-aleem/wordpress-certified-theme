...
if(isset($_POST['comm_postreview'])){
    $comm_post_rivew = $_POST['comm-postreview'];
    $submit_post_review_id = $_POST['community_post_review_id'];
        $add_review = array(
        'post_title'    => 'Review of '.$get_the_current_tit,
        'post_content'  => $comm_post_rivew,
        'post_status'   => 'publish',      
        ...
        if(!empty($review_id)){
            update_post_meta($review_id , 'comm_review_post_select', $submit_post_review_id); 
            $prev_review = get_post_meta($submit_post_review_id, 'community_post_reviews', true);
            if(!empty($prev_review)){
                $prev_review[] = $review_id;
            }else{
                $prev_review = array($review_id);
            }
            update_post_meta($submit_post_review_id ,'community_post_reviews', $prev_review); 
        }
...
if(isset($_POST['submit_comm_postreport'])){
    $current_post_id = get_the_ID();
    $comm_get_user_id = get_current_user_id();

   
    $submit_the_post_report = $_POST['comm_postreport'];
    
    $comm_post_report = get_post_meta(get_the_ID(), 'comm_repost_val', true);
    echo $comm_post_report;
    $has_error = false;
    ...
    update_post_meta($current_post_id, 'comm_repost_val', $comm_post_report);
    $this_page_link = (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https" : "http") . "://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]";
    if(empty($has_error)){
        wp_redirect($this_page_link);
        exit();
...
// Show the review post count
    $getprev_review = get_post_meta($current_post_id, 'community_post_reviews', true);
...
<section class="al_mainbg">
    ...
    <div class="container al_Hbannersec_new">
        ...
        <div class="row row flex-column-reverse flex-sm-row">
            ...
            <?php
                $get_imageone =  get_theme_mod("community_top_image");
                $get_image_two = get_theme_mod("community_bottom_image");
                $get_imageone_link = get_theme_mod("community_top_ads_link");
                $get_image_two_link = get_theme_mod("community_bottom_ads_link");
                $top_ads_codeone = get_theme_mod("community_top_ads_code");
                $top_ads_codetwo = get_theme_mod("community_bottom_ads_code");
                ...
                <form autocomplete="off" role="search" method="get"  action="<?php echo home_url( '/' ); ?>">
                    <div class="cf_search_input">
                        <div class="form-group">
                            <input type="text"  name="s" class="form-control cf_search-post"
                                placeholder="Type Here to Search Post" required>
            ...
            ?>
                <div class="row pt-3">
                    ...
                    <div class="offset-lg-2 col-lg-2 col-md-4 col-sm-12">
                        <div class="cf_comm_replies_tit">
                            <h4>Replies</h4>
                            <span><?php echo $post_review_count;?></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="cf_comm_usercount text-right">
                    ...
                    <span class="cf_comm_userliks">
                       ...
                       $total_count = get_post_meta( get_the_ID(), "wp_comm_count_total_count", true );
                    ...
                    <p> <?php
                             $post_date= get_the_time('F j, Y g:i a');
                ...
                <div class="row">
                    <div class="col-lg-11 col-md-12 col-sm-12">
                        ...
                        <div class="al_revicnlils cf_comm_usermb comm_shareicn">
                            <ul>
                                <li class="al_revshare pl-0">
                                    <a href="javascript:void(0)">
                                        <img src="<?php echo $dir_path;?>/public/image/shareicn.png"
                                ...
                                <li class="al_revmessageicn">
                                    <a href="#" class="comm_showreviewinp">
                                        <img src="<?php echo $dir_path;?>/public/image/messageicn.png"
                                            class="img-fluid">
                                    </a>
                                </li>
                                <li class="al_revfollow">
                                    <a href="#" class="user_comm_main_flow">
                                        <?php   
                                        $comm_user_following = get_user_meta( get_current_user_id() , "comm_user_following", true );
                                        ...
                                        ?>
                                        <?php 
                                            $post_author_id = get_post_field ('post_author', $get_the_post_id);
                                        ?>
                                        <input type="hidden" class="post_author_uid" value="<?php echo  $post_author_id;?>">
                                        <input type="hidden" class="curent_login_uid" value="<?php echo  $comm_get_user_id;?>">
                                    </a>
                                </li>
                            ...
                            <div class="row mb-4 comm_repost_post">
                                <div class="col-md-12 cf_tevl_ptwo_fm">
                                    <form method="POST" autocomplete="off">
                                        <textarea class="form-control mb-3" id="" name="comm_postreport" rows="6"
                                            ...
                                            <ul>
                                                <li class="pl-0">
                                                    <button type="submit" class="btn_active user_savebtn"
                                                        name="submit_comm_postreport">Submit Report</button>
                                                </li>
                                            </ul>
                                        </div>
                                    </form>
                            ...
                            <!-- Review on post -->
                            <div class="row mb-4 commnt_comt_sec">
                                <div class="col-md-12 cf_tevl_ptwo_fm">
                                    <form method="POST" autocomplete="off">
                                        <textarea class="form-control mb-3" id="" name="comm-postreview" rows="6"
                                            placeholder="Write a Reply..." required=""></textarea>
                                        <input type="hidden" name="community_post_review_id"
                                            value="<?= $get_the_post_id;?>">
                                        <div class="cf_user_savebtn">
                                            <ul>
                                                <li class="pl-0">
                                                    <button type="submit" class="btn_active user_savebtn"
                                                        name="comm_postreview" id="comm_submitreview">Post a
                                                        Reply</button>
                                                </li>
                                            </ul>
                                        </div>
            ...
            $prev_review = get_post_meta($current_post_id, 'community_post_reviews', true);
            ...
            if(!empty($prev_review )){
                ...
                $post_review_count =  $review_in_loop->post_count;
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 pl-0">
                        <div class="cf_replies_des">
                            ...
                            <div class="al_revicnlils cf_comm_usermb comm_shareicn comm_reviewshareicn">
                                <ul>
                                    <li class="al_revshare pl-0">
                                        <a href="javascript:void(0)" class="comm_show_reviewsincbtn">
                                            <img src="<?php echo $dir_path;?>/public/image/shareicn.png"
                                                class="img-fluid">
                                        </a>
                                    </li>
                                    ...
                                    <li class="al_revmessageicn">
                                        <a href="#" class="comm_pop_review_reply">
                                            <img src="<?php echo $dir_path;?>/public/image/messageicn.png"
                                                class="img-fluid" data-toggle="modal" data-target="#cf_replypop_modal">
                                    ...
                                    <li class="al_revfollow">
                                        <a href="#">
                                            <img src="<?php echo $dir_path;?>/public/image/follow.png"
                                                class="img-fluid">
                                        </a>
                                    </li>
                                    <li class="al_revflagicn">
                                        <a href="#" class="comm_report_btn">
                                            <img src="<?php echo $dir_path;?>/public/image/flagicn.png"
                                                class="img-fluid">
                                        </a>
                                    </li> 
                                    <?php
                                           ...
                                           ?>
                                            <li class="al_revflagicn">
                                                <a href="#" class="user_comm_delpost">
                                                    <img src="<?php echo $dir_path;?>/public/image/trash.png"
                                                        class="img-fluid">
                            ...
                            <?php
                                ...
                                if(!empty($get_comm_reply_on_review)){
                                    foreach($get_comm_reply_on_review as $replys){

                                        foreach($replys as $reply_onreview){
                                            ?>
                                           <div class="reply_onreview">
                                            <div class="row">
                                                <div class="col-lg-2">
                                                    <?php
                                                     $author_id = get_post_field( 'post_author', $reply_onreview['replyuid'] );
                                                     $get_the_img = get_avatar( get_the_author_meta($author_id) ); 
                                                     $user_image = get_user_meta( $reply_onreview['replyuid'] , 'user_image', true);
                                                     $img_scr = wp_get_attachment_image_src($user_image, 'full');
                                                     if(!empty($img_scr)){
                                                         ?>
                                                            <div class="cf_repli_img mt-0">
                                                ...
                                                <div class="col-lg-10 my-auto">
                                                    <p class="mb-0"> <?php   echo $reply_onreview['reply'];?></p>
                                                </div>
                                            </div>
                                        </div> 
                                            <?php
    ...
    <div class="modal fade" id="cf_replypop_modal" tabindex="-1" role="dialog" aria-labelledby="cf_replypop_modalLabel"
        aria-hidden="true">
