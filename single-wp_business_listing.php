...
$gat_the_bus_address = get_post_meta(get_the_ID() ,'wp_business_address',true );
...
<div class="container al_Hbannersec_new">
    ...
    if ( have_posts() ) :
        ...
        $call_action_text_value = get_post_meta( get_the_ID(), 'bus_call_action_text_value', true );
        $call_action_link_value = get_post_meta( get_the_ID(), 'bus_call_action_link_value', true );
        $services_value = get_post_meta( get_the_ID(), 'wp_business_services_value', true );
        $get_image_id = get_post_meta( get_the_ID(), '_business_image_gallery_val', true );
        $get_value = $services_value[0];
    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-12">
            <div >
                <h1 class="cf_bsheading"><span class="al_cfsubcolo"><?= get_the_title();?></span></h1>
            </div>
        </div>
...
<div class="container mb-20">
    <div class="row">
        <div class="col-md-12">
            <div class="multiitem single_busimg">
        <?php
        $arrs = explode(',',$get_image_id);
        if(!empty($arrs)):
           foreach($arrs as $image_id){
               if(!empty($image_id)){
                $featured_img_url =  wp_get_attachment_image_src($image_id , 'thumbnail');
                ?>
                <div class="">
                    <img src="<?php echo  $featured_img_url[0] ;?>" alt="Image Missing" class="img-fluid">
                </div>
                <?php
    ...
    <div class="row">
        ...
        <div class="offset-lg-2 offset-md-2  col-lg-4 col-md-4 col-sm-12">
            <div class="cf_infoadress">
                <h2>Address</h2>
                <p><?=  $gat_the_bus_address;?></p>
            </div>
            <div class="cf_infoactionbtn">
                <span class="cf_allactionbtn">
                    <a href="<?= $call_action_link_value;?>"><?= $call_action_text_value;?></a>
                </span>
                <!-- <span>
                    <a href="#">
    ...
    <div class="row mb-30">
        ...
        <div class="row">
            <div class="col-lg-9 col-md-9 col-sm-12">
                ...
                <div class="row mb-2">
                <?php
                $arrs = explode(',',$get_value);
                if($arrs):
                    foreach( $arrs  as $services){
                        ?>
